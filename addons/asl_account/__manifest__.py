...

{
    ...
    'license'   : 'AGPL-3',
    'depends'   : ['base', 'c10i_base', 'asl_base', 'c10i_account' ,'c10i_lhm', 'account_operating_unit'],
    'summary'   : """
                        ASL Accounting Module - C10i
                    """,
    'description'   : """
                        Customize Modul Accounting ASL.
                    """,
    'data'      : [
            'security/head_office_security.xml',
            'wizard/wizard_general_ledger_account_view.xml',
            'wizard/wizard_report_invoice_views.xml',
